...
public final class ErrorConstants {
    ...
    public static final String PROBLEM_BASE_URL = "https://www.stayhome-project.tech/problem";
    ...
    public static final URI GOUVERNORAT_NOT_FOUND_TYPE = URI.create(PROBLEM_BASE_URL + "/gouvernorat-not-found");
