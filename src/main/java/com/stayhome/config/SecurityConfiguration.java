...
public class SecurityConfiguration extends WebSecurityConfigurerAdapter {
    ...
    public void configure(HttpSecurity http) throws Exception {
        ...
        .and()
            ...
            .antMatchers(HttpMethod.GET, "/api/gouvernorats/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/delegations/**").permitAll()
            .antMatchers(HttpMethod.GET, "/api/municipalities/**").permitAll()
            // FIXME - Security issue
            .antMatchers(HttpMethod.GET, "/api/volunteers/**").permitAll()
