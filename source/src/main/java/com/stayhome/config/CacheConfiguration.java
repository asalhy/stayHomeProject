...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.stayhome.domain.Volunteer.class.getName());
            createCache(cm, com.stayhome.domain.Volunteer.class.getName() + ".serviceTypes");
            createCache(cm, com.stayhome.domain.Gouvernorat.class.getName());
            createCache(cm, com.stayhome.domain.Delegation.class.getName());
            createCache(cm, com.stayhome.domain.Municipality.class.getName());
